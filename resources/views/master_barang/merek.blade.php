...
<a href="{{ url('merek/addmerek') }}"><button type="button" class="btn btn-outline-primary"><i
...
<div class="h2 mb-3 text-center">Data Merek</div>
<hr style="width:75%">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Kumpulan Data Merek</h6>
    </div>
