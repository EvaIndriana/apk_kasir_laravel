...
<a href="{{ url('master_barang/kategori') }}"><button type="button" class="btn btn-outline-success"></i>Data Kategori</button></a>
<a href="{{ url('master_barang/merek') }}"><button type="button" class="btn btn-outline-success"></i>Data merek</button></a>
